 ...
 */
final class Version20200708060145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE articles (author INT DEFAULT NULL, Id INT AUTO_INCREMENT NOT NULL, Title VARCHAR(250) NOT NULL, Votes INT NOT NULL, Tags VARCHAR(250) NOT NULL, image VARCHAR(255) DEFAULT NULL, date DATETIME NOT NULL, content MEDIUMTEXT DEFAULT NULL, INDEX articles_fk (author), PRIMARY KEY(Id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE authors (Id INT AUTO_INCREMENT NOT NULL, Name VARCHAR(250) NOT NULL, Email VARCHAR(255) NOT NULL, Votes DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_8E0C2A51FE11D138 (Name), UNIQUE INDEX UNIQ_8E0C2A5126535370 (Email), PRIMARY KEY(Id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
